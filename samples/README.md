...
1. **Caddy Container**: Builds Caddy with the local RouteWarden module directly from source code (`samples/Dockerfile`) and exposes 14 dedicated test ports mapped in `samples/Caddyfile`.
